package com.example.jachiplus_back.security;
...
public class TokenProvider {
    ...
    private static final String SECRET_KEY = "Q4NSl604sgyHJj1qwEkR3ycUeR4uUAt7WJraD7EN3O9DVM4yyYuHxMEshjSF4XXyYJkal13eqgB0F7Tq4H";
    ...
    public String createToken(UserEntity userEntity) {
        ...
        return Jwts.builder()
                ...
                .setSubject(String.valueOf(userEntity.getId()))  // sub: 토큰 식별자
                .setIssuer("Jachiplus") // iss: 발급자 정보
